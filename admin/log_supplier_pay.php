  ...
  <div id="wrapper">
    ...
    ?>
      ...
      <div class="container"style="height: 50px;">
        <div class="row">
          <div class="span8">
            <ul class="breadcrumb" style="margin-top: -15px;">
              <li><a href="#"><i class="icon-home"></i></a><i class="icon-angle-right"></i></li>
                          <li class="active"><h2>This is Log of Supplier Payment</h2></li>
            </ul>
          </div>
          <div class="span4">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="span12">
               ...
               <table style="margin-top: 0px; font-family: Lucida Calligraphy;font-size: 16px; background:#3399CC;border-radius:5px;" border="1">
...
<th bgcolor="#ffff" width="250" STYLE="font-family:Script MT;">date</th>
...
<?php
  ...
  $retrive=mysqli_query($con,"select *from supp_pay_log");
