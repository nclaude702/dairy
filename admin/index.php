...
<body>
        ...
        <div class="row">
              ...
              <div class="widget">
                ...
                <h4 class="rheading">If You Want Another Report<span></span></h4>
                 <div class="">
                    ...
                    <a href="fomer_report.php"><button class="btn btn-theme" type="submit">Click Here To Get Former Enty Milk&nbsp&nbsp</button></a>
                    <a href="buyed_report.php" <button class="btn btn-theme" type="submit">Click here to get Product Buyed&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</button></a>
          ...
          <div class="span8">
            <section id="subintro">
              ...
              <table style="border-radius:5px; font-size: 22px;margin-top: -28px; border-style: 2px;" border="2">
                <?php
                try{
                $litre=0;
  ...
  <tr>
            ...
            <th rowspan="5" class="tds" bgcolor="" width="200px" height="50px" STYLE="font-family:Script MT;">Output Product / Ibyavuve mu mata bigurishwa</th>
...
?>
                  ...
                  <div class="text-center">
                    <a href="output_youghourt.php"><button class="btn btn-theme" type="submit" value=""> check old Yoghourt Report&nbsp&nbsp&nbsp&nbsp&nbsp</button></a>
                    <a href="output_cheese.php"><button class="btn btn-theme" type="submit">check old Cheese Report&nbsp</button></a>
                    <a href="output_milk.php"><button class="btn btn-theme" type="submit">check old Ikivuguto/ Inshushu Report</button></a>
                  </div>
