                 ...
                 <div class="row">
                    <div class="span8">
                      <ul class="breadcrumb" style="margin-top: -6px;">
                       ...
                       <li>
                       <h2>Reading Message From Client Mukamira Dairy</h2></li>
                     </ul>
                    </div>
                  </div>
                </div>
...
<th bgcolor="#ffff" width="130px" height="50px" STYLE="font-family:Script MT;">PHONE</th>

<th bgcolor="#ffff" width="130px" height="50px" STYLE="font-family:Script MT;">EMAIL</th>


<th bgcolor="#ffff" width="200px" height="50px" STYLE="font-family:Script MT;">MESSAGE</th>
<th bgcolor="#ffff" width="200px" height="50px" STYLE="font-family:Script MT;">ADDRESS</th>
...
try{
 ...
 include("../code/connection.php");
  $a=$con->prepare("select * from message order by mid desc");
  $a->execute();
...
<tr>
<td bgcolor="#FFFFFF" STYLE="font-family:Script MT;"><?php echo $row['mid'];?></td>
...
<td bgcolor="#FFFFFF" STYLE="font-family:Script MT;"><?php echo $row['email'];?></td>
...
<a href="code/delete_messg_code.php?id=<?php echo $id ?> "><img src="../assets/img/delete.jpg"class="img"style="width:80px;height:30px;" onclick="return confirm('dou you need to delete this message?')"/></a>
</td></tr>
