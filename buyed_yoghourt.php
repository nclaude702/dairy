...
<body>
  <div id="wrapper">
    ...
    <table>
        <form action="code/buyed_yoghourt_code.php" method="POST"> 
  <?Php
 $id=$_GET['id'];
...
try{
  ...
  <tr> <td>
    ...
    <input type="text" name="type" value="Yoghourt" readonly></td> </tr>
      <tr> <td>
...
?>
          ...
          <div class="span8">
            ...
            <img src="assets/img/yogh_cho.jpg"style="height:500px;width:600px;">
