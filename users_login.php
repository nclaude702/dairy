...
<body>
          ...
          <div class="span4">
            <aside>
              <div class="widget" style="width: 600px;">
                <h6 class="rheading">USERS LOGIN TO MUKAMIRA DAILY</h6>
  ...
  <div class="container">
    ...
    <table>
        <form action="users/code/login.php" method="POST">  
      <tr><td>
    ...
    <input type="password" placeholder="Enter Password" name="password" required></td></tr>
     <tr><td></td><td>
    <input type="submit" value="Users Login"class="btn btn-info" name="login"></td></tr>
