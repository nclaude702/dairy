...
<body>
  <div id="wrapper">
    ...
    <table>
        <form action="code/buyed_code.php" method="POST"> 
         <?Php
...
try{
  ...
  $sum=$con->prepare("select sum(capacity) from output_milk");
   $sum->execute();
  $h=$sum->fetch(PDO::FETCH_ASSOC);
  ...
  ?> 
  <tr> <td>
    <input type="number" name="id" value="<?php echo $id; ?>" readonly></td> </tr>
      <tr> <td>
    ...
    <tr> <td>
    <input type="text" placeholder="Enter Your E-mail" name="mail" ></td> </tr>
    ...
    <input type="text" name="type" value="<?php echo $row['milk_type'] ;?>" readonly></td> </tr>
     <tr>
...
?>
          ...
          <div class="span8">
            ...
            <img src="assets/img/milk2.jpg"style="height:510px;width:600px;">
