...
<body>
  <div id="wrapper">
      ...
      <div class="container">
        <div class="row">
          <div class="span4">
            <aside>
              <div class="widget">
                <h4 class="rheading">Add Cheese by <?php echo $_SESSION["names"]; ?><span></span></h4>
    ...
    <table>
      <form action="code/short_code/activate.php" method="POST">  
    ...
    <tr> <td>
      ...
      <input type="submit" value="Activate">
        ...
        <form action="code/add_cheese_code.php" method="POST">  
...
try{
  $d=date("d-m-y"); 
  $a=$con->prepare("SELECT * FROM `product_type` where type='CHEESE'");
  $a->execute();
...
<?php 
include("code/short_code/calculate_automated_cheese.php");
?>

  </td> </tr>
     <tr> <td>
    <?php 
include("code/short_code/calculate_automated_price_cheese.php");
?>
    ...
    <tr> <td>
    <input type="date" name="expired" value="<?php echo date('Y-m-d', strtotime(' +2 months')); ?>" readonly></td> </tr>
     <tr><td>
    <input type="submit" onclick="alert('thank you to add Cheese!')" value="Add Cheese"class="btn btn-info" name="insert"></td> </tr>
   </form>
  </div>
   </table>
              </div>    
