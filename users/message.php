                 ...
                 <div class="row">
                    <div class="span8">
                      <ul class="breadcrumb" style="margin-top: -6px;">
                       ...
                       <li>
                       <h3>Ubutumwa Bwoherejwe N'abaguzi N'aborozi</h3></li>
                     </ul>
                    </div>
                  </div>
                </div>
...
<a href="../code/deletemssge.php?id=<?php echo $id ?> "><img src="../assets/img/delete.jpg"class="img"style="width:80px;height:30px;" onclick="return confirm('dou you need to delete this message?')"/></a>
</td></tr>
