...
<body>
  <div id="wrapper">
      ...
      <div class="container">
        <div class="row">
          <div class="span4">
            <aside>
              <div class="widget">
                <h4 class="rheading">Update Yoghourt by <?php echo $_SESSION["names"]; ?><span></span></h4>
    ...
    <table>
        ...
        <form action="code/update_yoghurt_code.php" method="POST">  

    <tr> <td>
         <input  type="text" name="user" value="<?php echo $_SESSION["id"];?>" readonly>
      </td> </tr>
      <?Php
class update_Yoghourt{
  function __construct(){
include('../code/connection.php');
try{
  $id=$_GET['id'];
  $d=date("d-m-y"); 
  $a=$con->prepare("SELECT * FROM `output_youghurt` where id='$id'");
  $a->execute();
...
$obj=new update_Yoghourt();

?>
     <tr><td>

    <input type="submit" onclick="alert('thank you to Update Yoghourt!')" value="Update Yoghourt"class="btn btn-info" name="insert"></td> </tr>
   </form>
  </div>
   </table>
              </div>
