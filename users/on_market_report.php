                 ...
                 <div class="row">
                    <div class="span12">
                      <ul class="breadcrumb" style="margin-top: -6px;">
                       <li><a href="#"></i></a></li>
                       <li>
                       <h2>Selling Product Report Of Mukamira Dairy</h2></li>
                     </ul>
                    </div>
                  </div>
                </div>
...
<th bgcolor="#ffff" width="290px" height="50px"STYLE="font-family:Script MT;">product_id</th>
...
<td bgcolor="#FFFFFF" STYLE="font-family:Script MT;"><?php echo $price=$row['price'];?>Rwf</td>
<td bgcolor="#FFFFFF" STYLE="font-family:Script MT;"><?php echo $row['input_date'];?></td>
<td bgcolor="#FFFFFF" STYLE="font-family:Script MT;"><?php echo $row['expired_date'];?></td>
...
<tr>
  ...
  <td bgcolor="#FFFFFF" STYLE="" colspan="">price</td>
  <td bgcolor="#FFFFFF" STYLE="" colspan=""><?php echo $total;?>Rwf</td>
...
<table style="border-radius:5px; font-size: 22px;margin-top: 0px; border-style: 2px;" border="2" width="940">
              <tr>
<th bgcolor="#ffff" width="50px" height="50px"STYLE="font-family:Script MT;">user_id</th>
<th bgcolor="#ffff" width="130px" height="50px" STYLE="font-family:Script MT;">id</th>
...
?>
                  ...
                  <div class="text-center">
                    <a href="today_buyed_report.php"><button class="btn btn-theme" type="submit" value="">Click Here To Day Purchased Product Only Report</button></a>
