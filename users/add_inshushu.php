...
<body>
  <div id="wrapper">
      ...
      <div class="container">
        <div class="row">
          <div class="span4">
            <aside>
              <div class="widget">
                <h4 class="rheading">Add Inshyushyu by <?php echo $_SESSION["names"]; ?><span></span></h4>
    ...
    <table>
        ...
        <form action="code/short_code/activate_inshushu.php" method="POST">  
      ...
      <input type="submit" value="Activate">
        ...
        <form action="code/add_inshushu_code.php" method="POST">  
...
try{
  ...
  $a=$con->prepare("SELECT * FROM `product_type` where type='INSHUSHU'");
  $a->execute();
...
?>
    ...
    <tr> <td>    
<?php 
include("code/short_code/calculate_automated_inshushu.php");
?>
</td> </tr>
    <tr> <td>
    ...
    <input type="date" name="expired" value="<?php echo date('Y-m-d', strtotime(' +2 months')); ?>" required></td> </tr>
     <tr><td>
    <input type="submit" value="Ongera Inshushu"class="btn btn-info" name="insert"></td> </tr>
                 ...
                 <div class="row">
                    <div class="span8">
                      <ul class="breadcrumb" style="margin-top: -6px;">
                       ...
                       <li>
                       <h3>Ongera Amata Y'Inshyushu</h3></li>
                     </ul>
                    </div>
                  </div>
                </div>
...
<th bgcolor="#ffff" width="70px" height="50px" STYLE="font-family:Script MT;">id</th>
<th bgcolor="#ffff" width="80px" height="50px" STYLE="font-family:Script MT;">capacity</th>
<th bgcolor="#ffff" width="50px" height="50px" STYLE="font-family:Script MT;" >price</th>
<th bgcolor="#ffff" width="80px" height="50px" STYLE="font-family:Script MT;" >milk type</th>
...
try{
  include("../code/connection.php");
   ...
   //include("code/expiration_milk.php");
  $a=$con->prepare("SELECT * FROM `output_milk`  where milk_type='INSHUSHU'");
  $a->execute();
  while($row=$a->fetch(PDO::FETCH_ASSOC)){
...
<a href="update_inshyushu.php?id=<?php echo $id ?> "> update</a>
</td></tr>
