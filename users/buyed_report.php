                 ...
                 <div class="row">
                    <div class="span12">
                      <ul class="breadcrumb" style="margin-top: -6px;">
                       <li><a href="#"></i></a></li>
                       <li>
                       <h2>Bought Report To <?php echo $_SESSION["names"]; ?> User Of Mukamira Dairy</h2></li>
                     </ul>
                    </div>
                  </div>
                </div>
...
<td bgcolor="#FFFFFF" STYLE="font-family:;"><?php echo $row['type'];?></td>

<td bgcolor="#FFFFFF" STYLE="font-family:Script MT;"><?php echo $row['quantity'];?></td>
<td bgcolor="#FFFFFF" STYLE="font-family:Script MT;"><?php echo $row['price'];?>Rwf</td>
<td bgcolor="#FFFFFF" STYLE="font-family:Script MT;"><?php echo $row['total_payment'];?>Rwf</td>
