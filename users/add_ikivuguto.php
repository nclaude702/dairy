...
<body>
  <div id="wrapper">
      ...
      <div class="container">
        <div class="row">
          <div class="span4">
            <aside>
              <div class="widget">
                <h4 class="rheading">Add Ikivuguto by <?php echo $_SESSION["names"]; ?><span></span></h4>
    ...
    <table>
        ...
        <form action="code/short_code/activate_ikivug.php" method="POST">  
      ...
      <input type="submit" value="Activate">
        ...
        <form action="code/add_ikivug_code.php" method="POST">  
...
try{
  ...
  $a=$con->prepare("SELECT * FROM `product_type` where type='IKIVUGUTO'");
  $a->execute();
...
?>
    ...
    <tr> <td>    
<?php 
include("code/short_code/calculate_automated_ikivuguto.php");
?>
</td> </tr>
    <tr> <td>
    ...
    <input type="date" name="expired" value="<?php echo date('Y-m-d', strtotime(' +2 months')); ?>" required></td> </tr>
     <tr><td>
    <input type="submit" value="Ongera Ikivuguto"class="btn btn-info" name="insert"></td> </tr>
