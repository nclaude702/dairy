...
<body>
  <div id="wrapper">
      ...
      <div class="container">
        <div class="row">
          <div class="span4">
            <aside>
              <div class="widget">
                <h4 class="rheading">Update Inshyushyu by <?php echo $_SESSION["names"]; ?><span></span></h4>
    ...
    <table>
       ...
       <form action="code/update_inshyushu_code.php" method="POST">  

    <tr> <td>
         <input  type="text" name="user" value="<?php echo $_SESSION["id"];?>" readonly>
      </td> </tr>
      <?Php
class update_inshyushu_code{
...
$obj=new update_inshyushu_code();

?>
     <tr><td>

    <input type="submit" onclick="alert('thank you to Update inshyushu!')" value="Update Inshyushu"class="btn btn-info" name="insert"></td> </tr>
...
<a href="update_market_yoghurt.php?id=<?php echo $id ?> "> update</a>
</td></tr>
